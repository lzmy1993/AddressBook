...
- (UIImage*)screenShotWithKeyboard
{
                          ...
                          completion:(void (^)())completion
{
    ...
    for (NSInteger i = 0; i < totalIter; i++) {
        ...
        CGFloat curveP = progressOfSegmentWithinTotalProgress(curvesAnimationStart, curvesAnimationEnd, t);
...
static inline CGFloat easeInOutInterpolate(CGFloat t, CGFloat a, CGFloat b)
{
...
static BCPoint bezierAxisIntersection(BCBezierCurve curve, BCAxis axis, CGFloat axisPos)
{
    ...
    const NSInteger kIterations = 3; // Newton-Raphson iterations
